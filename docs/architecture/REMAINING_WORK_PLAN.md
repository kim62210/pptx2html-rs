...
- **Charts**: approximate direct rendering now covers clustered, stacked, and percent-stacked bar/column charts plus simple line, single-series bubble with area semantics and bounded bubbleScale support, single-series radar, single-series pie/doughnut, and flat-rendered single-series pie3D charts, but richer labels, axes, and additional chart families remain.
