...
| Charts | `approximate` | `rendered` | `approximate` | Chunk 3 | Clustered single- and multi-series bar/column charts plus simple line and pie charts now render directly; other chart families still fall back to preview image or placeholder |
