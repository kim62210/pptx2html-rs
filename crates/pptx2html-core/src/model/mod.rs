...
pub use slide::{
    AutoFit, Bullet, BulletAutoNum, BulletChar, ChartData, ChartGrouping, ChartSeries,
    ChartSpec, ChartType, ConnectionRef, CropRect, GroupData, ParagraphDefRPr, PictureData,
    Shape, ShapeType, Slide, TableCell, TableData, TableRow, TextBody, TextMargins,
